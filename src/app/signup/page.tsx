  ...
  <div className="flex items-center justify-center min-h-screen">
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      ...
      <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">
        Boas-Vindas a Nexa<strong className="text-nexa_lime">_</strong>
      </h2>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            ...
            <Input id="firstname" placeholder="Nexano User" type="text" />
          </LabelInputContainer>
        </div>
      ...
      <div className="">
        <h2>Ja é um Nexa User? <Link className="text-nexa_lime underline" href="/login" passHref>Entre aqui</Link></h2>
